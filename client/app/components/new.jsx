        ...
        .then(function(response) {
          if(response.error.error)
            Alert.error(response.error.message);
              ...
              Alert.success("L'article a été sauvegardé avec succès")
              hashHistory.push('article/'+response.data.id+'?new=true');
          }
        });
      }
    else {
      Alert.error("Le body, le titre et le topic sont requis.");
    }
  }
  ...
  render() {
    ...
    return (
      <div className="new-article">
        <div className="row">
         ...
         <div className="row">
          <div className="col-md-12 new-article-form">
            ...
            <trix-editor toolbar="my_toolbar" input="my_input" placeholder="Commencer à écrire ici...." class="input-body"></trix-editor>
        ...
        <br/>
        <div className="col-md-12">
          <button className="btn btn-default btn-block btn-lg" onClick={this.handleSubmit}>Créer</button>
        </div>
      </div>
    );
  }
