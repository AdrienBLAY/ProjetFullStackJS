...
class Admin extends React.Component {
    ...
    .then(function(response) {
      if(response.error.error)
        Alert.error(response.error.message);
          ...
          Alert.success('L\'utilisateur a été ajouté');
      }
    });
  }
    ...
    .then(function(response) {
      if(response.error.error) {
         ...
         Alert.error(response.error.message);
          ...
          Alert.success('Le topic a été ajouté');
      }
    });
  }
  ...
  deleteTopic(id,e) {
    ...
    .then(function(response) {
      if(response.error.error)
        ...
        that.setState({topics: topics});
        Alert.success('Le topic a été supprimé');
      }
    });
  }
  ...
  deleteUser(id,e) {
    e.preventDefault();
    var del = confirm("Supprimé cet utilisateur va transferer tous ses articles à l'admin. Etes vous sur de vouloir continuer ?");
    if(del==true) {
        var myHeaders = new Headers({
            "Content-Type": "application/x-www-form-urlencoded",
            "x-access-token": window.localStorage.getItem('userToken')
        ...
        .then(function(response) {
          if(response.error.error)
            ...
            that.setState({users: users});
            Alert.success('L\'utilisateur a été supprimé');
          }
        });
    }
  }
      ...
      return <Loader />
        ...
        return(
          ...
          <div className="col-md-6">
            <button className="btn btn-default" data-toggle="modal" data-target="#addTopic">Ajouter un Topic</button>
            <br/>
            <br/>
              <div className="list-group bordered-scroll-box">
                  {this.state.topics.map(topic => (
                    <div key={topic.id} href="#" className="list-group-item">
                      ...
                      <Link to={'topic/edit/'+topic.id} className="btn btn-default">Modifier</Link>
                      <button className="btn btn-default" type="button" onClick={(e) => this.deleteTopic(topic.id,e)}>Supprimer</button>
                      </span>: ''}
          ...
          <div className="col-md-6">
            <button className="btn btn-default" data-toggle="modal" data-target="#addUser">Ajouter un Utilisateur</button>
            <br/>
            <br/>
            <div className="list-group bordered-scroll-box">
                  {this.state.users.map(user => (
                    <div key={user.id} href="#" className="list-group-item">
                      {(user.id!=1) ? <span className="pull-right">
                        <Link to={'user/edit/'+user.id} className="btn btn-default">Modifier</Link>
                        <button className="btn btn-default" type="button"onClick={(e) => this.deleteUser(user.id,e)}>Supprimer</button>
                      </span> : ''}
                ...
                <div className="modal-body">
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-6 col-sd-12">
                      <h1><b>Ajouter un utilisateur</b></h1>
                      <br/>
                        <form>
                      ...
                      <div className="col-sm-12 form-group">
                        <button onClick={this.addUser} className="btn btn-default btn-block btn-lg">Ajouter</button>
                      </div>
                    </form>
                    </div>
                  </div>
              ...
              <div className="modal-content">
                ...
                <div className="modal-body">
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-6 col-sd-12">
                      <h1><b>Ajouter un Topic</b></h1>
                      <br/>
                        <form>
                          <div className="col-sm-12 form-group">
                            <input type="text" className="form-control" ref="topic_name" id="inputTopicName" placeholder="Nom" />
                          </div>
                          <div className="col-sm-12 form-group">
                            <input type="text" className="form-control" ref="topic_description" id="inputTopicAbout" placeholder="Description" />
                          </div>
                      <div className="col-sm-12 form-group">
                        <button onClick={this.addTopic} className="btn btn-default btn-block btn-lg">Ajouter</button>
                      </div>
                    </form>
                    </div>
                  </div>
