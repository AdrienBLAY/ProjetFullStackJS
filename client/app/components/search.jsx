      ...
      return(<div>
            <div className="result-info">
              <p className="help-block">
                Nous avons trouvé {this.state.articles.length} articles pour cette recherche
              </p>
            </div>
            ...
            <div key={article.id} className="article-item">
              ...
              <div className="article-item-description">
                Dernière mise à jour le {new Date(article.updated_at).toDateString()}
              </div>
        ...
        <div className="no-results">
          ...
          <p>Veuillez essayez avec une autre recherche</p>
        </div>
