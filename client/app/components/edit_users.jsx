    ...
    .then(function(response) {
      if(response.error.error)
        Alert.error(response.error.message);
          ...
          Alert.success('L\'utilisateur a été modifié');
          ...
          <div>
                  <div className="row">
                    <div className="col-md-12 col-sd-12">
                      <h1><b>Modifier l'utilisateur</b></h1>
                      <br/>
                        <form>
                          <div className="col-sm-12 form-group">
                            <input type="text" className="form-control" ref="user_name" id="inputUserName" placeholder="Nom" value={this.state.name} onChange={this.handleChange} />
                          </div>
                          <div className="col-sm-12 form-group">
                            <input type="text" className="form-control" ref="user_about" id="inputUserAbout" placeholder="A propos" value={this.state.about} onChange={this.handleChange}/>
                          </div>
                          <div className="col-sm-12 form-group">
                      ...
                      <div className="col-sm-12 form-group">
                        <button onClick={this.editUser} className="btn btn-default btn-block btn-lg">Modifier</button>
                      </div>
                    </form>
                    </div>
                  </div>
